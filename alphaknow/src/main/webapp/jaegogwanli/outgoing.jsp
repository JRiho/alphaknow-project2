...
.search_wrap input, .date-select {
	border: 1px solid rgba(0, 0, 0, 0.1);
	border-radius: 5px;
}

.search_wrap input:hover, .date-select:hover {
	outline: 1px solid rgb(50, 50, 230);
}

.search_wrap input:focus, .date-select:focus {
	outline: 1px solid rgb(50, 50, 230);
}
...
<body>
	...
	<div id="content">
                        ...
                        <div class="form">
                            ...
                            <!-- <div class="date-select-container"> -->
                                ...
                                <div id="end-date-select">
                                    ...
                                    <span class="calendar-button" id="end-calendar">📅</span>
                                </div>

                                <!-- 숨겨진 날짜 선택기 입력 필드 -->
                                <input type='text' id='hidden-start-datepicker' />
                                <input type='text' id='hidden-end-datepicker' />
                            </div>
                        <!-- </div> -->
                    </div>
                    </li>
        ...
        <footer>
            <div id="main_button">
                <!-- 신규등록 및 수정버튼-->
                <button id="outgoing_search" class="change_button"><a href = "outgoing_list.html">검색</a></button>
