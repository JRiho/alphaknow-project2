...
<link rel="stylesheet"
	href="<%=contextPath%>/alphaknow/css/equipment_production_performance_chart.css">
<script
	src="<%=contextPath%>/alphaknow/js/equipment_production_performance_chart.js"></script>
</head>
<style>
</style>
